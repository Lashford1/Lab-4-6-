...
def print_menu_line(direction, leads_to):
    ...
    """
    #pass
    direction_capitals = direction.upper()
    print("Go "+ direction_capitals + " to", leads_to +".")
...
def print_menu(exits):
    ...
    for direction in exits:
        print_menu_line(direction, exits[direction])
...
def menu(exits):
    ...
    while True:
        ...
        user_input = input()
        return user_input
        #normalised_user_choice = normalise_input(user_choice)
